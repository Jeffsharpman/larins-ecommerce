<div class="bg-background min-h-screen selection:bg-primary/20 selection:text-primary">
    ...
    <header class="relative pt-32 pb-24 px-6 border-b border-border/50 overflow-hidden">
        ...
        <div class="absolute top-0 right-0 w-150 h-150 bg-primary/5 blur-[140px] rounded-full -translate-y-1/2 translate-x-1/4 pointer-events-none"></div>
        <div class="absolute bottom-0 left-0 w-100 h-100 bg-primary/[0.02] blur-[100px] rounded-full translate-y-1/2 -translate-x-1/4 pointer-events-none"></div>
        <div class="absolute top-1/2 right-[-5%] w-112.5 h-112.5 bg-secondary/5 blur-[120px] rounded-full pointer-events-none"></div>
        ...
        <div class="max-w-7xl mx-auto flex flex-col lg:flex-row items-center lg:items-end gap-16 relative z-10">
            ...
            <div class="relative group">
                <div class="absolute -inset-4 bg-linear-to-tr from-primary/20 to-transparent rounded-[3.5rem] blur-2xl opacity-0 group-hover:opacity-100 transition duration-1000"></div>
                <div class="absolute -inset-4 bg-linear-to-tr from-secondary/10 to-transparent rounded-[3.5rem] blur-2xl opacity-0 group-hover:opacity-60 transition duration-1000 delay-300"></div>
                <div class="relative w-56 h-56 md:w-72 md:h-72 bg-card rounded-[3rem] border border-border p-10 flex items-center justify-center shadow-card backdrop-blur-sm">
                    @if($brand->image)
                        <img src="{{ $brand->image }}" alt="{{ $brand->name }}" class="w-full h-full object-contain filter grayscale group-hover:grayscale-0 group-hover:scale-110 transition-all duration-1000">
                    @else
            ...
            <div class="flex-1 space-y-8 text-center lg:text-left pb-4">
                <div class="space-y-4">
                    <div class="inline-flex items-center gap-4 group cursor-default">
                        <div class="h-px w-10 bg-primary group-hover:w-16 transition-all duration-500"></div>
                        <div class="h-px w-6 bg-secondary/40 group-hover:w-10 transition-all duration-500"></div>
    ...
    <main class="max-w-7xl mx-auto py-24 px-6">
        <div class="flex items-center gap-8 mb-20 group">
            ...
            <div class="h-[1px] flex-1 bg-linear-to-r from-border via-border/50 to-transparent"></div>
        </div>
