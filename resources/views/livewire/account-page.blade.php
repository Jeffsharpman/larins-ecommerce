      ...
      <div class="mb-16">
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
          ...
          <div class="flex items-center gap-4">
            <a href="/logout"
              class="group px-8 py-3 bg-muted text-foreground text-[10px] font-black uppercase tracking-[0.3em] rounded-full border border-border hover:bg-destructive hover:text-destructive-foreground hover:border-destructive transition-all duration-500 flex items-center gap-2">
        ...
        <div id="account-tabs" class="relative" data-hs-tabs="#account-tabs">
          ...
          <div class="mt-10">
            ...
            <div id="profile-tab" role="tabpanel" wire:key="tab-profile"
              ...
              <div class="grid gap-12 lg:grid-cols-3">
                ...
                <div class="lg:col-span-2 space-y-10">
                  <div class="bg-card border border-border rounded-[3rem] p-10 md:p-14 backdrop-blur-sm hover:border-secondary/20 transition-all duration-500">
                    <div class="flex items-center gap-4 mb-12">
                      ...
                      <div>
                        <h2 class="text-2xl font-black uppercase tracking-tighter italic text-foreground">Personal
                          Credentials</h2>
                        <p class="text-[9px] font-bold text-muted-foreground uppercase tracking-widest">Update your
                          boutique profile</p>
                      </div>
                    </div>
                    ...
                    <form wire:submit="updateProfile" class="grid gap-y-10 gap-x-8 md:grid-cols-2">
                      <div class="space-y-3">
                        <label
                          class="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground ml-1">First
                          Name</label>
                      ...
                      <div class="space-y-3">
                        <label class="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground ml-1">Last
                          Name</label>
                      ...
                      <div class="md:col-span-2 space-y-3">
                        ...
                        <input type="email" value="{{ $user->email }}" disabled
                          class="w-full bg-muted border border-border rounded-2xl px-6 py-4 text-xs font-bold tracking-widest text-muted-foreground transition-all outline-none cursor-not-allowed">
                      </div>
                      <div class="space-y-3">
                        <label
                        ...
                        <div class="relative">
                          <span
                            class="absolute left-6 top-1/2 -translate-y-1/2 text-[10px] font-black text-muted-foreground border-r border-border pr-3">+234</span>
                          <input type="tel" wire:model="phone" placeholder="8012345678"
                            class="w-full bg-background border border-border focus:border-primary focus:ring-4 focus:ring-primary/10 rounded-2xl pl-20 pr-6 py-4 text-xs font-bold tracking-widest text-foreground transition-all outline-none">
                        </div>
                      </div>
                      <div class="space-y-3">
                        <label
                          class="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground ml-1">Birthday</label>
                      ...
                      <div class="md:col-span-2 pt-6 flex flex-col sm:flex-row items-center gap-6">
                        <button type="submit"
                          class="w-full sm:w-auto px-12 py-5 bg-foreground text-background text-[10px] font-black uppercase tracking-[0.3em] rounded-full hover:bg-primary hover:text-primary-foreground transition-all duration-500 shadow-card active:scale-95">
                          Save Credentials
                        </button>
                      </div>
                    </form>
                ...
                <div class="space-y-8">
                  {{-- Member Card --}}
                  <div
                    class="bg-foreground text-background rounded-[3rem] p-10 relative overflow-hidden group shadow-card">
                    <div
                    ...
                    <div class="relative z-10 space-y-12">
                      ...
                      <div>
                        ...
                        <p class="text-2xl font-black italic tracking-tighter uppercase">
                  ...
                  <div class="grid grid-cols-2 gap-6">
                    <div
                      ...
                      <p
                        ...
                        {{ $totalOrders }}</p>
                      <p class="text-[9px] font-black uppercase tracking-[0.2em] text-muted-foreground mt-2">Archives
                      </p>
                    </div>
                    <div
                      class="bg-card border border-border p-8 rounded-[2rem] text-center hover:border-primary/40 hover:shadow-secondary/5 transition-all group relative">
                      ...
                      <p
                        class="text-3xl font-black italic text-primary group-hover:scale-110 transition-transform duration-500">
                        {{ $totalWishlist }}</p>
                      <p class="text-[9px] font-black uppercase tracking-[0.2em] text-muted-foreground mt-2">Favorites
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="bg-card border border-border rounded-[2.5rem] p-8 space-y-5">
                    <h4 class="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground mb-4 px-2">
                      Account Security</h4>

                    <button
                      class="w-full flex items-center justify-between p-4 rounded-2xl hover:bg-background border border-transparent hover:border-border transition-all group">
                      <span class="text-[10px] font-black uppercase tracking-widest text-foreground">Update Secret
                        Code</span>
                      <x-lucide-chevron-right
                        class="w-4 h-4 text-muted-foreground group-hover:text-primary transition-all group-hover:translate-x-1" />
                    </button>
                    ...
                    <button
                      ...
                      <div class="flex items-center gap-3">
                        <span
                          class="text-[10px] font-black uppercase tracking-widest text-foreground">Two-Factor</span>
                        <span
                          class="text-[8px] px-2 py-0.5 bg-destructive/10 text-destructive font-black rounded uppercase">Inactive</span>
                      </div>
              ...
              <div class="bg-card border border-border rounded-[3rem] p-10 md:p-14">
                <div class="flex items-center justify-between mb-12">
                  <div class="flex items-center gap-4">
                    ...
                    <div>
                      <h2 class="text-2xl font-black uppercase tracking-tighter italic text-foreground">Boutique
                        Shipping</h2>
                      <p class="text-[9px] font-bold text-muted-foreground uppercase tracking-widest">Your delivery
                        destinations</p>
                    </div>
                  </div>
                    ...
                    @foreach ($addresses as $address)
                      <div
                        ...
                        <div class="flex gap-3 pt-4 border-t border-border">
                          @if (!$address['is_active'])
                            <button wire:click="setActiveAddress({{ $address['id'] }})"
                              class="text-[9px] font-black uppercase tracking-widest text-primary hover:underline">Set
                              as Default</button>
                          @endif
                          <button wire:click="openAddressModal({{ $address['id'] }})"
                            class="text-[9px] font-black uppercase tracking-widest text-muted-foreground hover:text-foreground">Edit</button>
            ...
            {{-- Address Modal --}}
            @if ($showAddressModal)
              <div class="fixed inset-0 z-50 flex items-center justify-center p-4" x-data="{ modalOpen: true }"
                ...
                <div class="relative bg-card border border-border rounded-[3rem] p-10 w-full max-w-lg shadow-xl"
                  x-show="modalOpen" x-transition:enter="transition ease-out duration-300"
            ...
            @if ($showDeleteModal)
              <div class="fixed inset-0 z-50 flex items-center justify-center p-4" wire:click.self="closeDeleteModal">
                ...
                <div
                  class="relative bg-card border border-border rounded-[3rem] p-10 w-full max-w-md shadow-xl animate-in zoom-in-95 duration-200">
                  <div class="text-center">
                    ...
                    <h3 class="text-xl font-black uppercase tracking-tighter italic text-foreground mb-2">Delete
                      Address</h3>
                    <p class="text-muted-foreground text-sm mb-8">Are you sure you want to delete this address? This
                    ...
                    <div class="flex gap-4">
                      ...
                      <button wire:click="deleteAddress"
                        class="flex-1 px-6 py-4 bg-destructive text-destructive-foreground rounded-full text-[10px] font-black uppercase tracking-[0.3em] hover:bg-destructive/90 transition-all">Delete</button>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <div
                        ...
                        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                          <div class="flex items-center gap-6">
                            ...
                            <div>
                              <p class="text-[10px] font-black uppercase tracking-[0.3em] text-primary mb-1">Order
                                #{{ substr($order->id, 0, 8) }}</p>
                              <p class="text-lg font-black italic text-foreground">{{ $order->items->count() }} Items
                              </p>
                              <p class="text-[9px] text-muted-foreground uppercase tracking-wider mt-1">
                ...
                @else
                  <div class="text-center py-16 relative">
                    ...
                    <a href="/products" wire:navigate
                      class="mt-6 inline-block px-8 py-3 bg-primary text-primary-foreground text-[10px] font-black uppercase tracking-[0.3em] rounded-full">
                      Explore Collection
                    </a>
                  </div>
                @endif
