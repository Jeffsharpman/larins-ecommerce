        ...
        @else
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                ...
                <div class="lg:col-span-8 space-y-8 animate-in fade-in slide-in-from-left-4 duration-700">
                    ...
                    <a href="{{ route('shop') }}" class="inline-flex items-center gap-2 text-[9px] font-black uppercase tracking-[0.3em] text-muted-foreground hover:text-primary transition-colors group">
                        <x-lucide-chevron-left class="w-3 h-3 group-hover:-translate-x-1 transition-transform" />
                ...
                <aside class="lg:col-span-4 lg:sticky lg:top-24">
                    <div class="bg-card/50 backdrop-blur-3xl rounded-[2.5rem] p-10 border border-border shadow-card relative overflow-hidden">
                        ...
                        <button wire:click="checkout" wire:loading.attr="disabled"
                            class="w-full py-6 bg-primary text-primary-foreground rounded-3xl font-black uppercase tracking-[0.3em] text-[10px] shadow-xl shadow-primary/20 transition-all duration-500 hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-4 group disabled:opacity-70">
