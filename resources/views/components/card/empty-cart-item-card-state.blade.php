    ...
    <div class="flex flex-col items-center justify-center relative overflow-hidden group/main">
      ...
      <div class="relative group mb-10">
        ...
        <div
          ...
          <x-lucide-shopping-bag class="w-16 h-16 text-slate-300 dark:text-slate-700 stroke-[0.5] group-hover:text-primary transition-colors duration-700" />
        </div>
      </div>
      ...
      <div class="text-center space-y-4 max-w-sm px-8 relative z-10">
        ...
        <p
          class="text-[11px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-[0.25em] leading-relaxed pt-3 opacity-80">
      ...
      <div class="mt-16 flex items-center gap-4 opacity-30 dark:opacity-10">
        <span class="h-[1px] w-12 bg-gradient-to-r from-transparent to-slate-400 dark:to-slate-600"></span>
        <span class="text-[9px] font-black uppercase tracking-[0.6em] text-slate-400"> Maison {{ $site->site_name }}</span>
        <span class="h-[1px] w-12 bg-gradient-to-l from-transparent to-slate-400 dark:to-slate-600"></span>
      </div>
    </div>
  </td>
</tr>