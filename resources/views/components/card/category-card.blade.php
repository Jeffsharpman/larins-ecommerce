...
<a wire:navigate href="{{ route('categories.show', $category->slug) }}"
   class="group relative block bg-card dark:bg-card border border-border dark:border-border p-8 md:p-10 rounded-[3rem] overflow-hidden transition-all duration-700 ease-expo hover:border-primary/40 hover:-translate-y-3 shadow-sm hover:shadow-[0_40px_80px_-20px_rgba(var(--primary-rgb),0.1)]"
   wire:key="category-{{ $category->id }}">
    ...
    <div class="relative flex items-center z-10">
        ...
        <div class="relative flex-shrink-0 w-28 h-28 md:w-44 md:h-44 rounded-full overflow-hidden border border-border dark:border-border shadow-2xl transition-all duration-700 group-hover:shadow-primary/20">
