    ...
    <div class="flex flex-col items-center justify-center relative overflow-hidden group/main">
      ...
      <div class="relative group mb-10">
        ...
        <div
          ...
          <x-lucide-scroll class="w-16 h-16 text-muted-foreground stroke-[0.5] group-hover:text-primary transition-colors duration-700" />
        </div>
      </div>
      ...
      <div class="relative z-10 space-y-4 max-w-sm">
        ...
        <p
          class="text-[11px] font-bold text-muted-foreground uppercase tracking-[0.25em] leading-relaxed pt-3 px-4">
      ...
      <div class="mt-14">
        <a href="/products" wire:navigate
          class="group relative inline-flex items-center gap-x-6 px-14 py-6 text-[10px] font-black uppercase tracking-[0.4em] rounded-full bg-foreground text-background hover:bg-primary hover:text-primary-foreground transition-all duration-700 shadow-[0_20px_50px_-10px_rgba(var(--primary-rgb),0.3)]">
          <span>Explore Collection</span>
          <x-lucide-arrow-right class="w-5 h-5 transition-all duration-500 group-hover:translate-x-3" />
        </a>
      </div>

      {{-- Bottom Decorative Sparkle --}}
      <div class="mt-16 opacity-20 dark:opacity-5">
          <x-lucide-sparkles class="w-6 h-6 text-muted-foreground animate-pulse" />
      </div>
