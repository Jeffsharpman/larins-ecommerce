    ...
    <div class="flex flex-col items-center justify-center relative overflow-hidden group/main">
      ...
      <div class="mt-14">
        <a href="/products" wire:navigate
          class="group relative inline-flex items-center gap-x-6 px-14 py-6 text-[10px] font-black uppercase tracking-[0.4em] rounded-full bg-foreground dark:bg-background text-card dark:text-foreground hover:bg-primary dark:hover:bg-primary hover:text-white transition-all duration-700 shadow-[0_20px_50px_-10px_rgba(var(--primary-rgb),0.3)]">
