...
return [
    ...
    */
    ...
    'custom_permissions' => [
        'View:GeneralSettings' => 'View General Settings',
        'Create:GeneralSettings' => 'Create General Settings',
        'Update:GeneralSettings' => 'Update General Settings',
        'Delete:GeneralSettings' => 'Delete General Settings',
        'Restore:GeneralSettings' => 'Restore General Settings',
        'ForceDelete:GeneralSettings' => 'Force Delete General Settings',
    ],
